...
public class CommandFactory {
    ...
    static {
        ...
        CONFIG.put("dbAssert",DBAssertNewConfig.class);
        CONFIG.put("dbassert",DBAssertNewConfig.class);
        ...
        CONFIG.put("dataHolder",DataHolderStepConfig.class);
        CONFIG.put("dataholder",DataHolderStepConfig.class);
        CONFIG.put("dbinit",DBInitConfig.class);
        CONFIG.put("dbInit",DBInitConfig.class);
        CONFIG.put("dataAssert",DataAssertConfig.class);
        CONFIG.put("dataassert",DataAssertConfig.class);
        CONFIG.put("log",LogServiceConfig.class);
        loadAllConfigs();
    }
